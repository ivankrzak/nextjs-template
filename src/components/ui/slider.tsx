...
>(({ className, isRange, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border border-slate-200 bg-white ring-offset-background drop-shadow-sm transition-colors focus-visible:outline-none disabled:pointer-events-none dark:border-slate-500 dark:bg-slate-600" />
    {isRange && (
      <SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border border-slate-200 bg-white ring-offset-background drop-shadow-sm transition-colors focus-visible:outline-none disabled:pointer-events-none dark:border-slate-500 dark:bg-slate-600" />
    )}
  </SliderPrimitive.Root>
