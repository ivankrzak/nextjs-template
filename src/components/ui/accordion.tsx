...
const accordionVariants = {
  root: cva('text-slate-500 dark:text-slate-400', {
    variants: {
      variant: {
        flush: '',
        default: '',
  ...
  item: cva('', {
    variants: {
      variant: {
        flush: 'group border-b last:border-b-0 dark:border-slate-700',
        default: '',
        separated: '',
      },
    },
  ...
  trigger: cva('', {
    variants: {
      variant: {
        flush:
          '[&>div>svg]:text-slate-800 dark:[&>div>svg]:text-slate-400 [&>svg]:text-slate-900 dark:[&>svg]:text-slate-400 dark:[&[data-state=open]>div>svg]:text-white dark:[&[data-state=open]>svg]:text-white dark:[&[data-state=open]]:text-white',
        default: '',
        separated: '',
      },
    },
  ...
  content: cva('', {
    variants: {
      variant: {
        flush: 'border-t group-last:border-t-0 dark:border-slate-700',
        default: '',
        separated: '',
      },
    },
